...
@Table(name = "grn_details_has_item_details") // mapping table
...
public class GrnHasItem {
    ...
    @ManyToOne // GrnHasItem(many)------grn(one)
    @JoinColumn(name = "grn_details_id", referencedColumnName = "id") // FK
    ...
    @ManyToOne // GrnHasItem(many)------item(one)
